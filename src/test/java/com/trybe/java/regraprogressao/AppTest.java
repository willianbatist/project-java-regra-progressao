...
public class AppTest {
   ...
   */
  @Test
  @DisplayName("3 - Verifica a soma dos pesos.")
  public void testSomaPesos() {
    String input = """ 
        2
        Exercício Alfa
        40
    ...
    try {
      ...
      String actualOutput = outStream.toString();
      String cleanActualOutput = normalizeString(actualOutput);
      String cleanExpectedOutput = normalizeString(EXPECTED_TEXT_TO_SUM_WEIGHT);
      assertTrue(cleanActualOutput.contains(cleanExpectedOutput));
    } finally {
      System.setIn(sysInBackup);
      System.setOut(sysOutBackup);
   ...
   */
  @Test
  @DisplayName("4.1 - Emite o resultado correto quando há aprovação.")
   ...
   */
  @Test
  @DisplayName("4.2 - Emite o resultado correto quando há reprovação.")
